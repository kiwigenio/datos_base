...
int main() {
    ...
    while (true) {
        ...
        cout << "7. Ejecutar Consulta (Volcano Model)" << endl;
        cout << "8. Ejecutar Join (Nested Loop + Index)" << endl;
        cout << "9. Insertar en Tabla B (páginas 75-99)" << endl;
        cout << "10. Ver Hit Rate del Buffer Pool" << endl;
        cout << "11. Ejecutar Prueba Exhaustiva" << endl;
